...
function About() {
  return (
    <article className="row justify-content-evenly">
      <h2 className="col-12 d-flex justify-content-center m-3">About Me</h2>
      <img
        src={image}
        alt="profile"
        className="col-6 col-sm-4 col-md-4 col-lg-3 col-xl-3"
      ></img>
      <p className="col-11 col-sm-11 col-md-7 col-lg-6 col-xl-6 my-auto justify-content-center m-6">
        <span>
          <strong>Full stack web developer </strong>
        </span>
        with a background in construction. Earned Certificate in MERN Full Stack
